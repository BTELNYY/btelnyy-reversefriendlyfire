package me.btelnyy.reversefriendlyfire;
...
import me.btelnyy.reversefriendlyfire.listener.EventListener;
...
import me.btelnyy.reversefriendlyfire.service.file_manager.FileManager;
...
public class ReverseFriendlyFire extends JavaPlugin {

    // An instance of the plugin, so we don't need to make everything static
    private static ReverseFriendlyFire instance;
    ...
    public static ReverseFriendlyFire getInstance() {
        return instance;
    }
